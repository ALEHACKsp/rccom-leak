...
float CheckBoxFlagsSize = 10.5f;
float CheckBoxBackgroundSize = 8.f;
float CheckBoxFactor = 1.5;
ImVec4 CheckBoxActiveCol{ 0.000000000f, 0.501960814f, 0.000000000f, 1.000000000f };
ImVec4 CheckBoxInactiveCol{ 1.00f, 1.00f, 1.00f, 0.940f };
bool ImGui::Checkbox(const char * label, bool * v)
{
	...
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (7 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (6 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (5 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (4 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (3 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (2 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (1 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x / 2, check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20f, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - (1 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - (2 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - (3 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - (4 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxBackgroundSize, GetColorU32(ImVec4(0.20, 0.25f, 0.30f, 1.0f)), 15);
	...
	if (*v)
	{
		...
		//window-> DrawList- >AddRectFilled(ImVec2(check_bb.Min.x + / (check_bb.Max.x - check_bb.Min.x) / 2, check_bb.Min.y), check_bb.Max, GetColorU32 (ImVec4 (0.34 f, 1.0f, 0.54f, 1.0f), 0);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + (7 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxFlagsSize, GetColorU32(ImGuiCol_SliderGrab), 15);
		/*window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + 5, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + 4, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + 3, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + 2, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + 1, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x / 2, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71f, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + check_bb.Max.x - check_bb.Min.x / 2 - 1, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x / 2 - 2, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - 3, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - 4, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - 5, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - 6, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(0.71, 0.18f, 0.29f, 1.00f)), 12);
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 + 6, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(1.0, 1.0f, 1.0f, 1.0f)), 12);*/
	}
	else
	{
		window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + (check_bb.Max.x - check_bb.Min.x) / 2 - (7 * CheckBoxFactor), check_bb.Min.y + 9), CheckBoxFlagsSize, GetColorU32(CheckBoxInactiveCol), 15);
	}
	if (label_size.x > 0.0f)
...
bool ImGui::SliderBehaviorT(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, TYPE* v, const TYPE v_min, const TYPE v_max, const char* format, float power, ImGuiSliderFlags flags, ImRect* out_grab_bb)
{
    ...
    else
    {
       ...
       float grab_t = SliderCalcRatioFromValueT<TYPE, FLOATTYPE>(data_type, *v, v_min, v_max, power, linear_zero_pos);
		...
		//DrawList->AddCircleFilled(ImVec2(*out_grab_bb->Min.x + 6, *out_grab_bb->Min.y + ((*out_grab_bb->Max.y - *out_grab_bb->Min.y) / 2)), 13, GetColorU32(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab, 0.2f), 20);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power)
{
   ...
   // RenderFrame(frame_bb.Min, frame_bb.Max, frame_col, true, g.Style.FrameRounding);
    ...
    // Render grab
	float Align = 4;
	window->DrawList->AddLine(ImVec2(frame_bb.Min.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / 2) + Align), ImVec2(frame_bb.Max.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / 2) + Align), GetColorU32(ImVec4(0.21f, 0.20f, 0.21f, 1.00f)));
	if (grab_bb.Max.x > grab_bb.Min.x)
	{
		window->DrawList->AddLine(ImVec2(frame_bb.Min.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / 2) + Align), ImVec2(grab_bb.Min.x, frame_bb.Min.y + ((frame_bb.Max.y - frame_bb.Min.y) / 2) + Align), GetColorU32(ImGuiCol_SliderGrab));
		window->DrawList->AddCircleFilled(ImVec2(grab_bb.Min.x + 6, grab_bb.Min.y + ((grab_bb.Max.y - grab_bb.Min.y) / 2) + Align), 5, GetColorU32(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab));
		if (g.ActiveId == id)
		{
			window->DrawList->AddCircleFilled(ImVec2(grab_bb.Min.x + 6, grab_bb.Min.y + ((grab_bb.Max.y - grab_bb.Min.y) / 2) + Align), 13, GetColorU32(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab, 0.2f), 20);
		}
	}
	...
	if (label_size.x > 0.0f)
	{
		RenderText(ImVec2(frame_bb.Max.x + style.ItemInnerSpacing.x, frame_bb.Min.y + style.FramePadding.y +Align), label);
	}
